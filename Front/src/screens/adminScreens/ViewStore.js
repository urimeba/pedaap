                            ...
                            <ScrollView style={{flex:1, width:'100%',padding:30}}>
                                    <View style={styles.caja}>
                                        <View style={styles.datosCaja}>
                                            ...
                                            <View style={styles.inputs}>
                                                <Text style={ styles.titulo}>{JSON.stringify(this.props.navigation.getParam('horaApertura', 'promo'))}</Text>
                                            </View>
                                            <Text style={styles.titulo1}>Hora de cierre</Text>
                                            <View style={styles.inputs}>
                                                <Text style={styles.titulo}>{JSON.stringify(this.props.navigation.getParam('horaCierre', 'promo'))}</Text>
                                            </View>
                                        </View>
                                    </View>
                                            ...
                                            <View style={styles.inputs}>
                                                <TextInput style={styles.titulo}
                                                 onChangeText={(nombre)=>this.setState({nombre})}
                                                    placeholder={JSON.stringify(this.props.navigation.getParam('nombre', 'promo'))}
                                                />
                                            </View>
                                            <Text style={styles.titulo1}>Direccion</Text>
                                            <View style={styles.grande}>
                                                ...
                                                placeholder={JSON.stringify(this.props.navigation.getParam('direccion', 'promo'))}
                                                />
                                            </View>
                                            <Text style={styles.titulo1}>Hora de apertura</Text>
                                            <View style={styles.inputs}>
                                                <TextInput style={ styles.titulo} 
                                                    ...
                                                    placeholder={JSON.stringify(this.props.navigation.getParam('horaApertura', 'promo'))}
                                                />
                                            </View>
                                            <Text style={styles.titulo1}>Hora de cierre</Text>
                                            <View style={styles.inputs}>
                                                <TextInput style={styles.titulo}
                                                    ...
                                                    placeholder={JSON.stringify(this.props.navigation.getParam('horaCierre', 'promo'))}
                                                />
                                            </View>
                                        </View>
                                    </View>
