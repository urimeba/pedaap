...
export default class App extends Component{
    ...
    caja= ({item})=>(
        <TouchableOpacity style={styles.caja} onPress={()=>this.props.navigation.navigate('ViewProduct',{nombre:item.nombre,
            precio:item.precio,
        ...
        <View style={styles.todo}>
            <View style={styles.container}>
                <View style={styles.arriba}>
                    ...
                    <View style={{flexDirection:'row',alignItems:'center',alignContent:'center', width:'100%',height:40}}>
                     <TextInput 
                                    style={styles.TInput}
                                    placeholder="Buscar"
